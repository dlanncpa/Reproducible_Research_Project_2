...
cache = TRUE\color{red}{\verb|cache = TRUE|}
...
echo = TRUE\color{red}{\verb|echo = TRUE|}
...
.Rmd\color{red}{\verb|.Rmd|}
.Rmd) document is loaded in the editor
Click the 
Knit HTML\color{red}{\verb|Knit HTML|}
KnitHTML button in the doc toolbar to preview your document.
In the preview window, click the 
Publish\color{red}{\verb|Publish|}
Publish button.
